...
import com.lastone.simpple.jwt.ValidationError;
...
public class ErrorHandlerController {
    ...
    @ExceptionHandler({BadCredentialsException.class, InternalAuthenticationServiceException.class, DisabledException.class})
